    ...
    <header className="sticky top-0 z-50 border-b border-white/5 bg-[#07070F]/90 backdrop-blur">
      <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3">
        ...
        <nav className="hidden items-center gap-6 text-sm md:flex">
          <Link href="/compare" className="text-white/50 hover:text-white transition-colors">Products</Link>
          <Link href="/food" className="text-white/50 hover:text-white transition-colors">Food</Link>
          <Link href="/rides" className="text-white/50 hover:text-white transition-colors">Rides</Link>
          <Link href="/flights" className="text-white/50 hover:text-white transition-colors">Flights</Link>
          <Link href="/grocery" className="text-white/50 hover:text-white transition-colors">Grocery</Link>
        </nav>
